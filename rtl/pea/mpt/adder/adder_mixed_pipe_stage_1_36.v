module adder_mixed_pipe_stage_1_36(
  clk, rst_n,
  a, b,
  a_zero, a_inf, a_nan,
  b_zero, b_inf, b_nan,
...
wire signed [9:0] sum_0;
wire signed [9:0] sum_1;
wire signed [9:0] sum_2;
wire signed [9:0] sum_3;

reg signed [9:0] sum_0_reg;
reg signed [9:0] sum_1_reg;
reg signed [9:0] sum_2_reg;
reg signed [9:0] sum_3_reg;
...
wire [19:0] int8_res_0;
wire [19:0] int8_res_1;
...
assign a_0 = ({10{compute_float}} & {1'b0, frac_larger_align[8:0]})
           | ({10{compute_int4}} & {a[8], a[8:0]})
           | ({10{!compute_float & !compute_int4}} & {1'b0, a[8:0]});

assign a_1 = ({10{compute_float}} & {1'b0, frac_larger_align[17:9]})
           | ({10{!compute_float}} & {a[17], a[17:9]});

assign a_2 = ({10{compute_float}} & {{6{frac_larger_align[21]}}, frac_larger_align[21:18]})
           | ({10{compute_int4}} & {a[26], a[26:18]})
           | ({10{!compute_float & !compute_int4}} & {1'b0, a[26:18]});

assign a_3 = ({10{!compute_float}} & {a[35], a[35:27]});

assign b_0 = ({10{compute_float}} & {1'b0, frac_smaller_align[8:0]})
           | ({10{compute_int4}} & {b[8], b[8:0]})
           | ({10{!compute_float & !compute_int4}} & {1'b0, b[8:0]});

assign b_1 = ({10{compute_float}} & {1'b0, frac_smaller_align[17:9]})
           | ({10{!compute_float}} & {b[17], b[17:9]});

assign b_2 = ({10{compute_float}} & {{6{frac_smaller_align[21]}}, frac_smaller_align[21:18]})
           | ({10{compute_int4}} & {b[26], b[26:18]})
           | ({10{!compute_float & !compute_int4}} & {1'b0, b[26:18]});

assign b_3 = ({10{!compute_float}} & {b[35], b[35:27]});
...
assign cal_frac_temp = {sum_2_reg[3:0], sum_1_reg[8:0], sum_0_reg[8:0]};
...
assign int8_res_0 = {sum_1_reg[9], sum_1_reg, sum_0_reg[8:0]};
assign int8_res_1 = {sum_3_reg[9], sum_3_reg, sum_2_reg[8:0]};

assign o = compute_float ? {8'd0, o_sign, o_exp, o_frac} :
           compute_int4 ? {sum_3_reg, sum_2_reg, sum_1_reg, sum_0_reg} :
            {int8_res_1, int8_res_0};

adder_10bit u_adder_int_0(
  .a   ( a_0   ),
  .b   ( b_0   ),
  .c_i ( c_i_0 ),
  .o   ( sum_0 ),
