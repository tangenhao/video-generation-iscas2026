module adder_mixed_pipe_stage_1_32(
  clk, rst_n,
  a, b,
  a_zero, a_inf, a_nan,
  b_zero, b_inf, b_nan,
...
wire signed [8:0] sum_0;
wire signed [8:0] sum_1;
wire signed [8:0] sum_2;
wire signed [8:0] sum_3;

reg signed [8:0] sum_0_reg;
reg signed [8:0] sum_1_reg;
reg signed [8:0] sum_2_reg;
reg signed [8:0] sum_3_reg;
...
wire [17:0] int8_res_0;
wire [17:0] int8_res_1;
...
assign a_0 = ({9{compute_float}} & {1'b0, frac_larger_align[7:0]})
           | ({9{compute_int4}} & {a[7], a[7:0]})
           | ({9{!compute_float & !compute_int4}} & {1'b0, a[7:0]});

assign a_1 = ({9{compute_float}} & {1'b0, frac_larger_align[15:8]})
           | ({9{!compute_float}} & {a[15], a[15:8]});

assign a_2 = ({9{compute_float}} & {{3{frac_larger_align[21]}}, frac_larger_align[21:16]})
           | ({9{compute_int4}} & {a[23], a[23:16]})
           | ({9{!compute_float & !compute_int4}} & {1'b0, a[23:16]});

assign a_3 = ({9{!compute_float}} & {a[31], a[31:24]});

assign b_0 = ({9{compute_float}} & {1'b0, frac_smaller_align[7:0]})
           | ({9{compute_int4}} & {b[7], b[7:0]})
           | ({9{!compute_float & !compute_int4}} & {1'b0, b[7:0]});

assign b_1 = ({9{compute_float}} & {1'b0, frac_smaller_align[15:8]})
           | ({9{!compute_float}} & {b[15], b[15:8]});

assign b_2 = ({9{compute_float}} & {{3{frac_smaller_align[21]}}, frac_smaller_align[21:16]})
           | ({9{compute_int4}} & {b[23], b[23:16]})
           | ({9{!compute_float & !compute_int4}} & {1'b0, b[23:16]});

assign b_3 = ({9{!compute_float}} & {b[31], b[31:24]});
...
assign cal_frac_temp = {sum_2_reg[5:0], sum_1_reg[7:0], sum_0_reg[7:0]};
...
assign int8_res_0 = {sum_1_reg[8], sum_1_reg, sum_0_reg[7:0]};
assign int8_res_1 = {sum_3_reg[8], sum_3_reg, sum_2_reg[7:0]};

assign o = compute_float_reg ? {4'd0, o_sign, o_exp, o_frac} :
           compute_int4 ? {sum_3_reg, sum_2_reg, sum_1_reg, sum_0_reg} :
            {int8_res_1, int8_res_0};

adder_9bit u_adder_int_0(
  .a   ( a_0   ),
  .b   ( b_0   ),
  .c_i ( c_i_0 ),
  .o   ( sum_0 ),
