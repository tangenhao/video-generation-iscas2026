module adder_mixed_pipe_stage_1_44(
  clk, rst_n,
  a, b,
  a_zero, a_inf, a_nan,
  b_zero, b_inf, b_nan,
...
wire signed [11:0] a_0;
wire signed [11:0] a_1;
wire signed [11:0] a_2;
wire signed [11:0] a_3;

wire signed [11:0] b_0;
wire signed [11:0] b_1;
wire signed [11:0] b_2;
wire signed [11:0] b_3;
...
wire signed [11:0] sum_0;
wire signed [11:0] sum_1;
wire signed [11:0] sum_2;
wire signed [11:0] sum_3;

reg signed [11:0] sum_0_reg;
reg signed [11:0] sum_1_reg;
reg signed [11:0] sum_2_reg;
reg signed [11:0] sum_3_reg;
...
wire [23:0] int8_res_0;
wire [23:0] int8_res_1;
...
assign a_0 = ({12{compute_float}} & {1'b0, frac_larger_align[10:0]})
           | ({12{compute_int4}} & {a[10], a[10:0]})
           | ({12{!compute_float & !compute_int4}} & {1'b0, a[10:0]});

assign a_1 = ({12{compute_float}} & {frac_larger_align[21], frac_larger_align[21:11]})
           | ({12{!compute_float}} & {a[21], a[21:11]});

assign a_2 = ({12{!compute_float}})
           & ({12{compute_int4}} & {a[32], a[32:22]})
           | ({12{!compute_int4}} & {1'b0, a[32:22]});

assign a_3 = ({12{!compute_float}} & {a[43], a[43:33]});

assign b_0 = ({12{compute_float}} & {1'b0, frac_smaller_align[10:0]})
           | ({12{compute_int4}} & {b[10], b[10:0]})
           | ({12{!compute_float & !compute_int4}} & {1'b0, b[10:0]});

assign b_1 = ({12{compute_float}} & {frac_smaller_align[21], frac_smaller_align[21:11]})
           | ({12{!compute_float}} & {b[21], b[21:11]});

assign b_2 = ({12{!compute_float}})
           & ({12{compute_int4}} & {b[32], b[32:22]})
           | ({12{!compute_int4}} & {1'b0, b[32:22]});

assign b_3 = ({12{!compute_float}} & {b[43], b[43:33]});
...
assign cal_frac_temp = {sum_1_reg[10:0], sum_0_reg[10:0]};
...
assign int8_res_0 = {sum_1_reg[11], sum_1_reg, sum_0_reg[10:0]};
assign int8_res_1 = {sum_3_reg[11], sum_3_reg, sum_2_reg[10:0]};

assign o = compute_float ? {16'd0, o_sign, o_exp, o_frac} :
           compute_int4 ? {sum_3_reg, sum_2_reg, sum_1_reg, sum_0_reg} :
            {int8_res_1, int8_res_0};

adder_12bit u_adder_int_0(
  .a   ( a_0   ),
  .b   ( b_0   ),
  .c_i ( c_i_0 ),
  .o   ( sum_0 ),
