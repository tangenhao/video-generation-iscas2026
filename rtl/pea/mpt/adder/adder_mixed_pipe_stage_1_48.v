module adder_mixed_pipe_stage_1_48(
  clk, rst_n,
  a, b,
  a_zero, a_inf, a_nan,
  b_zero, b_inf, b_nan,
...
wire signed [12:0] a_0;
wire signed [12:0] a_1;
wire signed [12:0] a_2;
wire signed [12:0] a_3;

wire signed [12:0] b_0;
wire signed [12:0] b_1;
wire signed [12:0] b_2;
wire signed [12:0] b_3;
...
wire signed [12:0] sum_0;
wire signed [12:0] sum_1;
wire signed [12:0] sum_2;
wire signed [12:0] sum_3;

reg signed [12:0] sum_0_reg;
reg signed [12:0] sum_1_reg;
reg signed [12:0] sum_2_reg;
reg signed [12:0] sum_3_reg;
...
wire [25:0] int8_res_0;
wire [25:0] int8_res_1;
...
assign a_0 = ({13{compute_float}} & {1'b0, frac_larger_align[11:0]})
           | ({13{compute_int4}} & {a[11], a[11:0]})
           | ({13{!compute_float & !compute_int4}} & {1'b0, a[11:0]});

assign a_1 = ({13{compute_float}} & {{3{frac_larger_align[21]}}, frac_larger_align[21:12]})
           | ({13{!compute_float}} & {a[23], a[23:12]});

assign a_2 = ({13{!compute_float}})
           & ({13{compute_int4}} & {a[35], a[35:24]})
           | ({13{!compute_float & !compute_int4}} & {1'b0, a[35:24]});

assign a_3 = ({13{!compute_float}} & {a[47], a[47:36]});

assign b_0 = ({13{compute_float}} & {1'b0, frac_smaller_align[11:0]})
           | ({13{compute_int4}} & {b[11], b[11:0]})
           | ({13{!compute_float & !compute_int4}} & {1'b0, b[11:0]});

assign b_1 = ({13{compute_float}} & {{3{frac_smaller_align[21]}}, frac_smaller_align[21:12]})
           | ({13{!compute_float}} & {b[23], b[23:12]});

assign b_2 = ({13{!compute_float}})
           & ({13{compute_int4}} & {b[35], b[35:24]})
           | ({13{!compute_float & !compute_int4}} & {1'b0, b[35:24]});

assign b_3 = ({13{!compute_float}} & {b[47], b[47:36]});
...
assign cal_frac_temp = {sum_1_reg[9:0], sum_0_reg[11:0]};
...
assign int8_res_0 = {sum_1_reg[12], sum_1_reg, sum_0_reg[11:0]};
assign int8_res_1 = {sum_3_reg[12], sum_3_reg, sum_2_reg[11:0]};

assign o = compute_float ? {20'd0, o_sign, o_exp, o_frac} :
           compute_int4 ? {sum_3_reg, sum_2_reg, sum_1_reg, sum_0_reg} :
            {int8_res_1, int8_res_0};

adder_13bit u_adder_int_0(
  .a   ( a_0   ),
  .b   ( b_0   ),
  .c_i ( c_i_0 ),
  .o   ( sum_0 ),
