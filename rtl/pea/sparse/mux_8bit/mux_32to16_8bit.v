...
mux_32to1_8bit u_mux_0 (
  .mask(mask_0_sel),
  .data(data),
  .out(out[7:0])
);

mux_32to1_8bit u_mux_1 (
  .mask(mask_1_sel),
  .data(data),
  .out(out[15:8])
);

mux_32to1_8bit u_mux_2 (
  .mask(mask_2_sel),
  .data(data),
  .out(out[23:16])
);

mux_32to1_8bit u_mux_3 (
  .mask(mask_3_sel),
  .data(data),
  .out(out[31:24])
);

mux_32to1_8bit u_mux_4 (
  .mask(mask_4_sel),
  .data(data),
  .out(out[39:32])
);

mux_32to1_8bit u_mux_5 (
  .mask(mask_5_sel),
  .data(data),
  .out(out[47:40])
);

mux_32to1_8bit u_mux_6 (
  .mask(mask_6_sel),
  .data(data),
  .out(out[55:48])
);

mux_32to1_8bit u_mux_7 (
  .mask(mask_7_sel),
  .data(data),
  .out(out[63:56])
);

mux_32to1_8bit u_mux_8 (
  .mask(mask_8_sel),
  .data(data),
  .out(out[71:64])
);

mux_32to1_8bit u_mux_9 (
  .mask(mask_9_sel),
  .data(data),
  .out(out[79:72])
);

mux_32to1_8bit u_mux_10 (
  .mask(mask_10_sel),
  .data(data),
  .out(out[87:80])
);

mux_32to1_8bit u_mux_11 (
  .mask(mask_11_sel),
  .data(data),
  .out(out[95:88])
);

mux_32to1_8bit u_mux_12 (
  .mask(mask_12_sel),
  .data(data),
  .out(out[103:96])
);

mux_32to1_8bit u_mux_13 (
  .mask(mask_13_sel),
  .data(data),
  .out(out[111:104])
);

mux_32to1_8bit u_mux_14 (
  .mask(mask_14_sel),
  .data(data),
  .out(out[119:112])
);

mux_32to1_8bit u_mux_15 (
  .mask(mask_15_sel),
  .data(data),
  .out(out[127:120])
);
