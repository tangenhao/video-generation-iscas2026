...
mux_16to1_8bit u_mux_0 (
  .mask(mask_0_sel),
  .data(data),
  .out(out[7:0])
);

mux_16to1_8bit u_mux_1 (
  .mask(mask_1_sel),
  .data(data),
  .out(out[15:8])
);

mux_16to1_8bit u_mux_2 (
  .mask(mask_2_sel),
  .data(data),
  .out(out[23:16])
);

mux_16to1_8bit u_mux_3 (
  .mask(mask_3_sel),
  .data(data),
  .out(out[31:24])
);

mux_16to1_8bit u_mux_4 (
  .mask(mask_4_sel),
  .data(data),
  .out(out[39:32])
);

mux_16to1_8bit u_mux_5 (
  .mask(mask_5_sel),
  .data(data),
  .out(out[47:40])
);

mux_16to1_8bit u_mux_6 (
  .mask(mask_6_sel),
  .data(data),
  .out(out[55:48])
);

mux_16to1_8bit u_mux_7 (
  .mask(mask_7_sel),
  .data(data),
  .out(out[63:56])
);
