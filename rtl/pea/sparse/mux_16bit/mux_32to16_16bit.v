...
mux_32to1_16bit u_mux_4 (
  .mask(mask_4_sel),
  .data(data),
  .out(out[79:64])
);

mux_32to1_16bit u_mux_5 (
  .mask(mask_5_sel),
  .data(data),
  .out(out[95:80])
);

mux_32to1_16bit u_mux_6 (
  .mask(mask_6_sel),
  .data(data),
  .out(out[111:96])
);

mux_32to1_16bit u_mux_7 (
  .mask(mask_7_sel),
  .data(data),
  .out(out[127:112])
);

mux_32to1_16bit u_mux_8 (
  .mask(mask_8_sel),
  .data(data),
  .out(out[143:128])
);

mux_32to1_16bit u_mux_9 (
  .mask(mask_9_sel),
  .data(data),
  .out(out[159:144])
);

mux_32to1_16bit u_mux_10 (
  .mask(mask_10_sel),
  .data(data),
  .out(out[175:160])
);

mux_32to1_16bit u_mux_11 (
  .mask(mask_11_sel),
  .data(data),
  .out(out[191:176])
);

mux_32to1_16bit u_mux_12 (
  .mask(mask_12_sel),
  .data(data),
  .out(out[207:192])
);

mux_32to1_16bit u_mux_13 (
  .mask(mask_13_sel),
  .data(data),
  .out(out[223:208])
);

mux_32to1_16bit u_mux_14 (
  .mask(mask_14_sel),
  .data(data),
  .out(out[239:224])
);

mux_32to1_16bit u_mux_15 (
  .mask(mask_15_sel),
  .data(data),
  .out(out[255:240])
);
