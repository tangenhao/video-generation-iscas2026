...
mux_16to1_4bit u_mux_0 (
  .mask(mask_0_sel),
  .data(data),
  .out(out[3:0])
);

mux_16to1_4bit u_mux_1 (
  .mask(mask_1_sel),
  .data(data),
  .out(out[7:4])
);

mux_16to1_4bit u_mux_2 (
  .mask(mask_2_sel),
  .data(data),
  .out(out[11:8])
);

mux_16to1_4bit u_mux_3 (
  .mask(mask_3_sel),
  .data(data),
  .out(out[15:12])
);

mux_16to1_4bit u_mux_4 (
  .mask(mask_4_sel),
  .data(data),
  .out(out[19:16])
);

mux_16to1_4bit u_mux_5 (
  .mask(mask_5_sel),
  .data(data),
  .out(out[23:20])
);

mux_16to1_4bit u_mux_6 (
  .mask(mask_6_sel),
  .data(data),
  .out(out[27:24])
);

mux_16to1_4bit u_mux_7 (
  .mask(mask_7_sel),
  .data(data),
  .out(out[31:28])
);
