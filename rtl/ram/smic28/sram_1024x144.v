...
genvar sram_i;
generate
  for (sram_i = 0; sram_i < 8; sram_i = sram_i + 1) begin : sram_1024x144
    sram_2p_uhde #(
      .BITS  ( 128  ),
      .WORDS ( 144  )
...
genvar i;
generate
  for(i=0;i<8;i=i+1) begin:u_sram_tsmc28_1024x144
