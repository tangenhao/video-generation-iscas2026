...
genvar sram_i;
generate
  for (sram_i = 0; sram_i < 4; sram_i = sram_i + 1) begin : sram_512x128
    sram_2p_uhde #(
      .BITS  ( 128 ),
      .WORDS ( 128 )
...
genvar i;
generate
  for(i=0;i<4;i=i+1) begin:u_sram_tsmc28_512x128
    TS6N28HPCPSVTA128X128M2FWBSO u_sram_tsmc28_128x128(
      .AA    ( w_addr                                       ),
      .D     ( w_data[i*128 +: 128]                         ),
      .BWEB  ( 128'd0                                       ),
      .WEB   ( !w_en                                        ),
