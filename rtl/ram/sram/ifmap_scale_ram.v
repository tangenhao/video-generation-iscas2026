...
assign dma_wen[1] = broadcast_reg ? (dma_waddr[(ADDR_BITS-2):(ADDR_BITS-BANK_BITS-1)] == 0) & dma_wvalid : (dma_waddr[(ADDR_BITS-2):(ADDR_BITS-BANK_BITS-1)] == 1) & dma_wvalid;

genvar sram_i;
generate
  for (sram_i = 0; sram_i < BANK; sram_i = sram_i + 1) begin : gen_ifmap_scale_sram
...
assign ren[0] = rvalid_0 && raddr_0[ADDR_BITS-2:ADDR_BITS-BANK_BITS-1] == 0;
