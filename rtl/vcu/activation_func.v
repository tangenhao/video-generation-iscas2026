module activation_func(
  ...
  psum_data, psum_1_data, ifmap_data, resadd_data, para_data,
  add_op1, add_op2, mul_op1, mul_op2, fma_op1, fma_op2, fma_op3, fast_func_op1, srt16_op1, srt16_op2, comp_op1, comp_op2, comp_op3, comp_op4, bit_op1,
...
input       [DATA_WIDTH-1:0] psum_1_data;
...
reg [DATA_WIDTH-1:0] op1_reg;
reg [DATA_WIDTH-1:0] op2_reg;
reg [DATA_WIDTH-1:0] op3_reg;
reg [DATA_WIDTH-1:0] op4_reg;
...
assign add_op1       = stream_select ? stream_op1_select : op1_reg;
assign add_op2       = stream_select ? stream_op2_select : op2_reg;
assign mul_op1       = stream_select ? stream_op1_select : op1_reg;
assign mul_op2       = stream_select ? stream_op2_select : op2_reg;
assign fma_op1       = stream_select ? stream_op1_select : op1_reg;
assign fma_op2       = stream_select ? stream_op2_select : op2_reg;
assign fma_op3       = stream_select ? stream_op3_select : op3_reg;
assign fast_func_op1 = stream_select ? stream_op1_select : op1_reg;
assign srt16_op1     = stream_select ? stream_op1_select : op1_reg;
assign srt16_op2     = stream_select ? stream_op2_select : op2_reg;
assign comp_op1      = stream_select ? stream_op1_select : op1_reg;
assign comp_op2      = stream_select ? stream_op2_select : op2_reg;
assign comp_op3      = stream_select ? stream_op3_select : op3_reg;
assign comp_op4      = stream_select ? stream_op4_select : op4_reg;
assign bit_op1       = stream_select ? stream_op1_select : op1_reg;

always @(posedge clk or negedge rst_n) begin
  if (!rst_n) begin
    op1_reg <= {DATA_WIDTH{1'b0}};
    op2_reg <= {DATA_WIDTH{1'b0}};
    op3_reg <= {DATA_WIDTH{1'b0}};
    op4_reg <= {DATA_WIDTH{1'b0}};
  end
  else if (execute_start && !stream_select) begin
    op1_reg <= op1;
    op2_reg <= op2;
    op3_reg <= op3;
    op4_reg <= op4;
      ...
      for (iteration_reg_i = 0; iteration_reg_i < REG_NUM; iteration_reg_i = iteration_reg_i+1) begin
        if (store_sign[iteration_reg_i]) begin
          if (config_sign) begin
            ...
            iteration_reg[iteration_reg_i] <= op1;
          end
          else begin
