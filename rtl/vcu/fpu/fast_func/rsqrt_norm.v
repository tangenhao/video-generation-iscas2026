...
assign out_temp[31] = 1'b0;
assign shift_number = lzd_o - 1;

assign sum_norm = sum << shift_number;

assign exp_mid = norm_exp - shift_number;
...
assign out = (data[30:0] == 8'b0) ? ( data[31] ? 32'hff800000 : 32'h7f800000) : 
                                    ( data[31] ? 32'hffffffff : ( (data[30:23] == 8'hff) ? ( (data[22:0] == 23'b0) ? 32'h0 : 32'h7fffffff) : out_temp ));

// shifter_left_64_6 shifter_left_64_6_rsqrt(
// .data(sum), 
// .shift(shift_number),
// .o(sum_norm)
// );
