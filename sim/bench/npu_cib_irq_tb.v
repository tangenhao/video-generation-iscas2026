...
initial begin
 // rst; 
  ...
  cmd_vld = 1;
  @(negedge axi4_clk) cmd_vld = 0;
  @(negedge u_axi_master.axi4_full_M_AXI_BVALID) #10cmd_in_wr(cmd, 'h3c0, 64'h0);
  cmd_vld = 1;
  @(negedge axi4_clk) cmd_vld = 0;
  @(negedge u_axi_master.axi4_full_M_AXI_BVALID) #10cmd_in_wr(cmd, 'h3e0, 64'h0);
  cmd_vld = 1;
  @(negedge axi4_clk) cmd_vld = 0;
  @(negedge u_axi_master.axi4_full_M_AXI_BVALID) #10cmd_in_wr(cmd, 'h440, 2);
  cmd_vld = 1;
  @(negedge axi4_clk) cmd_vld = 0;
  ...
  @(negedge u_axi_master.axi4_full_M_AXI_BVALID) #10cmd_in_wr(cmd, 'ha00, 1);
  cmd_vld = 1;
  @(negedge axi4_clk) cmd_vld = 0;
  ...
  wait(u_npu_top_chiplet.u_npu_top.insn_M_AXI_WVALID && u_npu_top_chiplet.u_npu_top.insn_M_AXI_WREADY && u_npu_top_chiplet.u_npu_top.insn_M_AXI_WDATA[3:0] == 2);
  wait(u_npu_top_chiplet.u_npu_top.insn_M_AXI_WVALID && u_npu_top_chiplet.u_npu_top.insn_M_AXI_WREADY && u_npu_top_chiplet.u_npu_top.insn_M_AXI_WDATA[3:0] == 8);

  #500 cmd_in_wr(cmd, 0, 1);
  cmd_vld = 1;
  @(negedge axi4_clk) cmd_vld = 0;
