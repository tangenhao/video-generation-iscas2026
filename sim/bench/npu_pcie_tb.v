...
parameter IFMAP_ADDR = 'h10000;
parameter WEIGHT_ADDR = 'h20000;
parameter OFMAP_ADDR = 'h30000;
parameter IFMAP_SCALE_ADDR = 'h40000;
...
parameter RECIPROCAL_ADDR = 'hc0000;
parameter LOG_ADDR = 'hc0800;
parameter EXP_ADDR = 'hc1000;
parameter RSQRT_ADDR = 'hc1800;
parameter TANH_ADDR = 'hc2000;
parameter SIGMOID_ADDR = 'hc2800;
parameter MISH_ADDR = 'hc3000;
parameter SWISH_ADDR = 'hc3800;
parameter GELU_ADDR = 'hc4000;
parameter SINCOS_ADDR = 'hc4800;
parameter CONFIG_ADDR = 'hd0000;

initial begin
  $readmemh("../memory/insn.txt", u_full_slave_ddr0.data_mem, INSN_ADDR);
  $readmemh("../memory/ifmap.txt", u_full_slave_ddr0.data_mem, IFMAP_ADDR);
  $readmemh("../memory/weight.txt", u_full_slave_ddr1.data_mem, WEIGHT_ADDR);
  $readmemh("../memory/weight.txt", u_full_slave_ddr0.data_mem, WEIGHT_ADDR);
  $readmemh("../memory/ifmap_scale.txt", u_full_slave_ddr0.data_mem, IFMAP_SCALE_ADDR);
  ...
  $readmemh("../memory/vcures.txt", u_full_slave_ddr1.data_mem, VCURES_ADDR);
  $readmemh("../memory/vcures.txt", u_full_slave_ddr0.data_mem, VCURES_ADDR);
  $readmemh("../memory/reciprocal.txt", u_full_slave_ddr0.data_mem, RECIPROCAL_ADDR);
  $readmemh("../memory/log.txt", u_full_slave_ddr0.data_mem, LOG_ADDR);
  $readmemh("../memory/exp.txt", u_full_slave_ddr0.data_mem, EXP_ADDR);
  $readmemh("../memory/rsqrt.txt", u_full_slave_ddr0.data_mem, RSQRT_ADDR);
  $readmemh("../memory/tanh.txt", u_full_slave_ddr0.data_mem, TANH_ADDR);
  $readmemh("../memory/sigmoid.txt", u_full_slave_ddr0.data_mem, SIGMOID_ADDR);
  $readmemh("../memory/mish.txt", u_full_slave_ddr0.data_mem, MISH_ADDR);
  $readmemh("../memory/swish.txt", u_full_slave_ddr0.data_mem, SWISH_ADDR);
  $readmemh("../memory/gelu.txt", u_full_slave_ddr0.data_mem, GELU_ADDR);
  $readmemh("../memory/sincos.txt", u_full_slave_ddr0.data_mem, SINCOS_ADDR);
  $readmemh("../memory/config.txt", u_full_slave_ddr0.data_mem, CONFIG_ADDR);
end

parameter psum_bits = 16;
parameter conv_len  = 65536;
...
task check(integer address);
  begin
    // 打开结果输出文件
    integer result_file;
    result_file = $fopen("../memory/result.txt", "w");
