...
Tensor<T> reduce_sum(Tensor<T>& input, int valid_items, bool debug = false)
{
  ...
  for (int i = 0; i < rows; i++) {
    ...
    for (int j = 0; j < 32 / 2; j++) {
      ...
      layer0[j] = a + b;
      if (debug) {
        std::cout << std::hex << "a: " << *(uint32_t*)(&a) << " b: " << *(uint32_t*)(&b)
                  << " sum: " << *(uint32_t*)(&layer0[j]) << std::endl;
      }
    }
    if (debug) {
    ...
    for (int j = 0; j < 16 / 2; j++) {
      ...
      if (debug) {
        std::cout << std::hex << "a: " << *(uint32_t*)(&a) << " b: " << *(uint32_t*)(&b)
                  << " sum: " << *(uint32_t*)(&layer1[j]) << std::endl;
      }
    }
    ...
    for (int j = 0; j < 8 / 2; j++) {
      ...
      if (debug) {
        std::cout << std::hex << "a: " << *(uint32_t*)(&a) << " b: " << *(uint32_t*)(&b)
                  << " sum: " << *(uint32_t*)(&layer2[j]) << std::endl;
      }
    }
    ...
    for (int j = 0; j < 4 / 2; j++) {
      ...
      if (debug) {
        std::cout << std::hex << "a: " << *(uint32_t*)(&a) << " b: " << *(uint32_t*)(&b)
                  << " sum: " << *(uint32_t*)(&layer3[j]) << std::endl;
      }
    }
    ...
    for (int j = 0; j < 2 / 2; j++) {
      ...
      if (debug) {
        std::cout << std::hex << "a: " << *(uint32_t*)(&a) << " b: " << *(uint32_t*)(&b)
                  << " sum: " << *(uint32_t*)(&layer4[j]) << std::endl;
      }
    }
