...
if __name__ == '__main__':
    ...
    md_path = args.input
    file_path = args.output if args.output else md_path.split('.')[0] + ".xlsx"
    assert "xlsx" in file_path, "Output file must be a .xlsx file"
    ...
    markdown_table.to_excel(file_path, index=False)
