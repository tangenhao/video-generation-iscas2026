...
const colors = { // TODO compare with WaveDrom
  ...
  8:  '#ff00ff', // 'hsl(300,100%,50%)'
  9:  '#00ffea', // 'hsl(195,100%,50%)'
  10: '#ff00bf', // 'hsl(330,100%,50%)'
  11: '#00ff80', // 'hsl(150,100%,50%)'
  12: '#ff0059', // 'hsl(0,100%,50%)'
  13: '#00ff40', // 'hsl(90,100%,50%)'
  14: '#ff0020', // 'hsl(0,100%,50%)'
  15: '#00ff20', // 'hsl(120,100%,50%)'
  16: '#ff0010', // 'hsl(0,100%,50%)'
  17: '#00ff10', // 'hsl(120,100%,50%)'
  18: '#ff0008', // 'hsl(0,100%,50%)'
  19: '#00ff08', // 'hsl(120,100%,50%)'
  20: '#ff0004', // 'hsl(0,100%,50%)'
  21: '#00ff04', // 'hsl(120,100%,50%)'
  22: '#ff0002', // 'hsl(0,100%,50%)'
  23: '#00ff02', // 'hsl(120,100%,50%)'
  24: '#ff0001', // 'hsl(0,100%,50%)'
  25: '#00ff01' // 'hsl(120,100%,50%)'
};
