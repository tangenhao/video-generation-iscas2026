...
if { ${DDC_HIER_DESIGNS} != ""} {
  set_top_implementation_options -block_references ${DDC_HIER_DESIGNS}
}
...
analyze -format verilog ${RTL_SOURCE_FILES} -define {TSMC28}
elaborate ${DESIGN_NAME}

# Remove the RTL version of the hierarchical blocks in case they were read in
set HIER_DESIGNS "${DDC_HIER_DESIGNS}"
...
report_timing -transition_time -nets -attributes -nosplit -max_paths 1000 -path full > ${REPORTS_DIR}/${FULL_TIMING_REPORT}
report_timing -transition_time -nets -attributes -nosplit -max_paths 1000 -path full -delay max > ${REPORTS_DIR}/${SETUP_TIMING_REPORT}
report_timing -transition_time -nets -attributes -nosplit -max_paths 1000 -path full -delay min > ${REPORTS_DIR}/${HOLD_TIMING_REPORT}
...
report_power -nosplit -hierarchy > ${REPORTS_DIR}/${DCRM_FINAL_POWER_REPORT}
