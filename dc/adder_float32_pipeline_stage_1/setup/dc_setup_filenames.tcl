...
set FULL_TIMING_REPORT                                  ${DESIGN_NAME}.mapped.full_timing.rpt
set SETUP_TIMING_REPORT                                 ${DESIGN_NAME}.mapped.setup_timing.rpt
set HOLD_TIMING_REPORT                                  ${DESIGN_NAME}.mapped.hold_timing.rpt
