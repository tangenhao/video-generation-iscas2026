...
set DESIGN_NAME                   "adder_float32_pipeline_stage_1"  ;#  The name of the top-level design
...
/SSD/maweize/work/dispatch/dc/adder_float32_pipeline_stage_1/constraints \
...
/SSD/TSMC/TSMCHOME/digital/Front_End/timing_power_noise/NLDM/tcbn28hpcplusbwp40p140_180a/tcbn28hpcplusbwp40p140tt1v25c.db
];
...
##########################################################################################
# PTPX Common Variables
#
# Define the following PTPX common variables for the reference methodology scripts
# for PTPX flows.
# Use as few or as many of the following definitions as needed by your design.
##########################################################################################

set PTPX_TB_INST_NAME            "fadd_tb/u_adder_float32_pipeline_stage_1"           ;# Testbench instance name
set PTPX_SIM_NAME                "/SSD/maweize/work/dispatch/sim/work"           ;# Simulation directory
set PTPX_WAVEFORM_NAME           "fadd_tb.fsdb"           ;# Waveform file
set PTPX_SAIF_NAME               "fadd_tb.saif"           ;# SAIF file
