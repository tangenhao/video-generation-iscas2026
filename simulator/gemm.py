...
class GemmSimulator():
    ...
    def Store(self):
        ...
        output_size = self.tile_m * self.k_group_size * self.block_n_group * self.input_bytes * self.num_cores
...
gemm_t = GemmSimulator(1, 4096, 4096, "int4xint4", 1, 16, 32, True, False, False, False, 16, 50, 0.5, 800, True)
print(gemm_t.run())