...
typedef struct {
  ...
  uint64_t store_insns : 2;            // 10 + 2 = 12
...
union store_cvt {
  store_4_bits store_4;
  store_3_bits store_3;
  store_2_bits store_2;
  insn_bits    insn;
};

template<int dma_id = 0>
struct store_iteration_4: public instruction {

  private:
  store_4_bits storage_t;

  public:
  store_iteration_4(): instruction() {}

  store_iteration_4(uint64_t low, uint64_t high): instruction(low, high) {}

  store_iteration_4(instruction& insn)
  {
    union store_cvt cvt;
    cvt.insn        = insn.storage;
    this->storage_t = cvt.store_4;
    this->set_insn();
  }

  store_iteration_4(uint64_t ddr_addr,
                    ...
                    uint64_t all_done)
  {
    ...
    this->storage_t.insn_opcode           = 9 + dma_id;
    this->storage_t.store_insns           = 0;
  ...
  int64_t get_store_insns()
  {
    return this->storage_t.store_insns;
  }
  ...
  {
    return (this->storage_t.hop_offset_1_fra_low | (this->storage_t.hop_offset_1_fra_high << 2));
  }
...
template<int dma_id = 0>
struct store_iteration_3: public instruction {

  private:
  store_3_bits storage_t;

  public:
  store_iteration_3(): instruction() {}

  store_iteration_3(uint64_t low, uint64_t high): instruction(low, high) {}

  store_iteration_3(instruction& insn)
  {
    union store_cvt cvt;
    cvt.insn        = insn.storage;
    this->storage_t = cvt.store_3;
    this->set_insn();
  }

  store_iteration_3(uint64_t ddr_addr,
                    uint64_t sequ_burst_0,
                    uint64_t hop_offset_1_exp,
                    uint64_t hop_offset_1_fra,
                    uint64_t sequ_burst_1,
...
template<int dma_id = 0>
struct store_iteration_2: public instruction {

  private:
  store_2_bits storage_t;

  public:
  store_iteration_2(): instruction() {}

  store_iteration_2(uint64_t low, uint64_t high): instruction(low, high) {}

  store_iteration_2(instruction& insn)
  {
    union store_cvt cvt;
    cvt.insn        = insn.storage;
    this->storage_t = cvt.store_2;
    this->set_insn();
  }

  store_iteration_2(uint64_t ddr_addr,
                    uint64_t sequ_burst_0,
                    uint64_t hop_offset_1_exp,
                    uint64_t hop_offset_1_fra,
                    uint64_t sequ_burst_1,
