...
int main(int argc, const char** argv)
{
  ...
  instruction_series.push_back(load_iteration_2(PSUM_ADDR, 112, 3, 112, 13, MASTER_PSUM_ADDR, 0));
  instruction_series.push_back(StoreIteration2(OFMAP_ADDR, 112, 3, 112, 13, MASTER_PSUM_ADDR, 1));

  uint64_t data_bytes = 28 * 14 * 32;
