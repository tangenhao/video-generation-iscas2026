...
int main(int argc, const char** argv)
{
  ...
  instruction_series.push_back(load_iteration_2(0, 55, 4, 112, 55, MASTER_PSUM_ADDR, 0));

  instruction_series.push_back(synchronize_indie(1, 0, 0, 2, 0, 0));
  instruction_series.push_back(store_iteration_2(0x0, 0, 0, 0, 0, MASTER_PSUM_ADDR, 0));

  instruction_series.push_back(synchronize_indie(1, 0, 0, 2, 0, 0));
  instruction_series.push_back(store_iteration_2(0x0, 1, 0, 0, 0, MASTER_PSUM_ADDR, 0));

  instruction_series.push_back(synchronize_indie(1, 0, 0, 2, 0, 0));
  instruction_series.push_back(store_iteration_2(0x0, 2, 0, 0, 0, MASTER_PSUM_ADDR, 0));

  instruction_series.push_back(synchronize_indie(1, 0, 0, 2, 0, 0));
  instruction_series.push_back(store_iteration_2(0x100, 55, 4, 112, 55, MASTER_PSUM_ADDR, 1));
