...
int main(int argc, const char** argv)
{
  ...
  instruction_series.push_back(common::insn::load_iteration_4(0, 55, 112, 5, 55, 0, 0, 0, 0, 0, 0, 0x30000, 0).get_instruction());

  instruction_series.push_back(common::insn::store_iteration_4(0, 55, 112, 5, 55, 0, 0, 0, 0, 0, 0, 0x30000, 1).get_instruction());
