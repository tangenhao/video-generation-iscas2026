...
int main(int argc, const char** argv)
{
  ...
  using upsample_t                    = vcu::UpsampleOp<kFloat32, kFloat32, true>;
  ...
  auto data_out = zeros<float>({oc_group, 14, 14, oc_group_size}, kFloat32);

  using upsample_sim_t           = compute_model::sample::UpsampleSim<float, float, true>;
