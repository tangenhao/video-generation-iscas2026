...
int main(int argc, const char** argv)
{
  ...
  using avgpool_t                   = vcu::AvgpoolOp<kFloat32, kFloat32, false>;
  ...
  auto data_out = zeros<float>({oc_group, 7, 7, oc_group_size}, kFloat32);

  using avgpool_sim_t           = compute_model::sample::Avgpool2dSim<float, float, true>;
