...
int main(int argc, const char** argv)
{
  ...
  using upsample_t                    = vcu::UpsampleOp<kHalf, kHalf, true>;
  ...
  auto data_out = zeros<half>({oc_group, 14, 14, oc_group_size}, kHalf);

  using upsample_sim_t           = compute_model::sample::UpsampleSim<half, half, true>;
