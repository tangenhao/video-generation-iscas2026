...
int main(int argc, const char** argv)
{
  ...
  using avgpool_t                   = vcu::AvgpoolOp<kHalf, kHalf, false>;
  ...
  auto data_in  = randn<half>({oc_group, h, w, oc_group_size}, kHalf, -1.0f, 1.0f, 0);
  auto data_out = zeros<half>({oc_group, 7, 7, oc_group_size}, kHalf);

  using avgpool_sim_t           = compute_model::sample::Avgpool2dSim<half, half, true>;
