...
int main(int argc, const char** argv)
{
  ...
  uint64_t valid_items = 32 * oc_group;
  /* -------------------------------------------------------------------------------------------------------- */
  /*                                                 data gen                                                 */
  /* -------------------------------------------------------------------------------------------------------- */
  ...
  auto data_out = compute_model::function::reduce_max(data_in, valid_items);
  ...
  auto vcucode_series = vcu::asm_vcu_op({"redmax psum, reg11, 20"});
