...
int main(int argc, const char** argv)
{
  ...
  auto data_out = compute_model::function::gelu(data_in);
  ...
  // auto vcucode_series = vcu::asm_vcu_op({"gelu psum, reg5"});
  auto vcucode_series = vcu::asm_vcu_op({"config reg3, 0.044715",
                                         "copy psum, reg0",
                                         ...
                                         "mul reg2 reg1, reg2"});                       // 0.5 * (x^3 * 0.044715 + x) * sqrt(2/pi)
