...
int main(int argc, const char** argv)
{
  ...
  // std::cout << std::hex << (*(uint32_t*)(&data_in[0])) << std::endl;
  // auto data_out = compute_model::function::abs(data_in);
  // std::cout << std::hex << (*(uint32_t*)(&data_out[0])) << std::endl;
  // data_out = compute_model::function::sqrt(data_out);
  // std::cout << std::hex << (*(uint32_t*)(&data_out[0])) << std::endl;
  // data_out = compute_model::function::inv(data_out);
  // std::cout << std::hex << (*(uint32_t*)(&data_out[0])) << std::endl;
  // data_out = compute_model::function::reciprocal(data_out);
  // std::cout << std::hex << (*(uint32_t*)(&data_out[0])) << std::endl;
  auto data_out = compute_model::function::exp2(data_in);
  // std::cout << std::hex << (*(uint32_t*)(&data_out[0])) << std::endl;
  // data_out = compute_model::function::rsqrt(data_out);
  // std::cout << std::hex << (*(uint32_t*)(&data_out[0])) << std::endl;
  // data_out = compute_model::function::reciprocal(data_out);
  // std::cout << std::hex << (*(uint32_t*)(&data_out[0])) << std::endl;
  ...
  auto vcucode_series = vcu::asm_vcu_op({"exp2 psum, reg1"});

  auto vcucode_number = vcucode_series.size();
  ...
  std::cout << vcucode_series.size() << std::endl;
