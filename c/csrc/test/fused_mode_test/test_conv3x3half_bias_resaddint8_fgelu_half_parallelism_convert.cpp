...
int main(int argc, const char** argv)
{
  ...
  using conv2d_t                         = npu_u::Conv2dOp<0, 0, 0, 0, kHalf, kHalf, kFloat32, kHalf, true>;
  ...
  auto weight    = randn<half>({oc_group, ic_group, kh, kw, oc_group_size, ic_group_size}, kHalf, -4.0f, 4.0f, 100);
  ...
  common::file_utils::saveCharArrayToFormattedTextFile(
    "../../sim/memory/bias_in.txt", reinterpret_cast<char*>(para.data_ptr()), para.numel() * sizeof(float), 256, true);
