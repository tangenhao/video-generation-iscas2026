...
int main(int argc, const char** argv)
{
  ...
  int dilation_h     = 1;
  int dilation_w     = 1;
  int ifmap_block_h  = 18;
  int ifmap_block_w  = 18;
  ...
  vcu::vcu_exe_args         vcu_exe_args = {kInt16, 1, 1, 0, 2, 0, 0, 0, 0, 0, 0, 0};
  conv2d_t::Arguments       args         = {h,
                              ...
                              vcu_cfg_args,
                              vcu_exe_args,
                              {"add psum para, reg6", "add reg6 resadd, reg11", "fastsig reg11, reg7"}};
  conv2d_t                  conv2d_op;
  ...
  auto resadd = randn<int16_t>({oc_group, ofmap_h, ofmap_w, oc_group_size}, kHalf, -2.0f, 2.0f, 8);
  ...
  vcu_ofmap      = compute_model::function::fast_sigmoid(resadd_out);
