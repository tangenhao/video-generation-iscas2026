...
int main(int argc, const char** argv)
{
  ...
  auto resadd = randn<int8_t>({oc_group, ofmap_h, ofmap_w, oc_group_size}, kHalf, -2.0f, 2.0f, 6);
  ...
  vcu_ofmap       = compute_model::function::sigmoid(resadd_out);
