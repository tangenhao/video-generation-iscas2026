...
int main(int argc, const char** argv)
{
  ...
  using conv2d_t                         = npu_u::Conv2dOp<0, 0, 0, 0, kBfloat16, kHalf, kFloat32, kInt4, false>;
  ...
  //--------------------------------------------------------------
  using conv2d_sim_t                  = compute_model::conv2d::Conv2dSim<0, false, false, false, bfloat16, half, float, float, false>;
