...
int main(int argc, const char** argv)
{
  ...
  using conv2d_t           = pea::Conv2dOp<SPARSE_ENABLE, 0, 0, 0, kBfloat16, kInt8, kFloat32, kFloat32, true>;
  ...
  auto weight_dense = randn<int8_t>({oc_group, ic_group / 2, kh, kw, oc_group_size, ic_group_size * 2}, kHalf, -128.0f, 127.0f, 100);
  ...
  using conv2d_sim_t = compute_model::conv2d::Conv2dSim<SPARSE_ENABLE, 0, false, false, bfloat16, int8_t, float, float, true>;
