...
int main(int argc, const char** argv)
{
  ...
  using conv2d_t           = pea::Conv2dOp<SPARSE_ENABLE, 0, 0, true, kInt8, kInt4, kFloat32, kFloat32, true>;
  ...
  using conv2d_sim_t                  = compute_model::conv2d::Conv2dSim<SPARSE_ENABLE, 0, false, true, int8_t, int4_t, float, float, true>;
