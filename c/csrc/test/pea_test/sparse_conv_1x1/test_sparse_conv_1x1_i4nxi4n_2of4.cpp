...
int main(int argc, const char** argv)
{
  ...
  using conv2d_t           = pea::Conv2dOp<SPARSE_ENABLE, true, true, false, kInt4, kInt4, kFloat32, kFloat32, true>;
  ...
  using conv2d_sim_t = compute_model::conv2d::Conv2dSim<SPARSE_ENABLE, true, true, false, int4_t, int4_t, float, float, true>;
