...
int main(int argc, const char** argv)
{
  ...
  using conv2d_t           = pea::Conv2dOp<SPARSE_ENABLE, 0, 0, 0, kInt8, kInt8, kInt32, kInt32, true>;
  ...
  auto ifmap_mask_int32 = zeros<int32_t>({oc_group, ic_group, kh, kw, oc_group_size, ic_group_size}, kInt32);
  ...
  using conv2d_sim_t = compute_model::conv2d::Conv2dSim<SPARSE_ENABLE, 0, false, false, int8_t, int8_t, int32_t, int32_t, true>;
