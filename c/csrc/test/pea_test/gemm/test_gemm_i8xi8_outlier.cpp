...
int main(int argc, const char** argv)
{
  ...
  using gemm_t           = pea::GemmOp<0, 0, 0, true, kInt8, kInt8, kFloat32, kFloat32, true>;
  ...
  auto ifmap         = randn<int8_t>({k_group, m, k_group_size}, kInt8, -128.0f, 127.0f, 0);
  ...
  using gemm_sim_t               = compute_model::gemm::GemmSim<0, 0, false, true, int8_t, int8_t, float, float, true>;
