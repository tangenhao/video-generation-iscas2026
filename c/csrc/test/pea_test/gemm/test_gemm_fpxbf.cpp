...
int main(int argc, const char** argv)
{
  ...
  using gemm_t           = pea::GemmOp<0, 0, 0, 0, kHalf, kBfloat16, kFloat32, kFloat32, false>;
  ...
  using gemm_sim_t = compute_model::gemm::GemmSim<0, 0, false, false, half, bfloat16, float, float, true>;
