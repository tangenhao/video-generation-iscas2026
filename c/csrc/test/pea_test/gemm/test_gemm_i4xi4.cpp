...
int main(int argc, const char** argv)
{
  ...
  using gemm_t           = pea::GemmOp<0, 0, 0, 0, kInt4, kInt4, kInt32, kInt32, true>;
  ...
  using gemm_sim_t = compute_model::gemm::GemmSim<0, 0, false, false, int4_t, int4_t, int32_t, int32_t, true>;
