...
int main(int argc, const char** argv)
{
  ...
  using gemm_t           = pea::GemmOp<0, 0, 0, 0, kBfloat16, kInt4, kFloat32, kFloat32, true>;
  ...
  using gemm_sim_t = compute_model::gemm::GemmSim<0, 0, false, false, bfloat16, int4_t, float, float, true>;

  auto ifmap  = randn<bfloat16>({k_group, m, k_group_size}, kBfloat16, -8.0f, 7.0f, 0);
