...
int main(int argc, const char** argv)
{
  ...
  using gemm_t           = pea::GemmOp<0, 0, 0, 0, kBfloat16, kInt8, kFloat32, kFloat32, false>;
  ...
  using gemm_sim_t = compute_model::gemm::GemmSim<0, 0, false, false, bfloat16, int8_t, float, float, true>;
