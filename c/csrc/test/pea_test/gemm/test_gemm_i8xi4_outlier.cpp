...
int main(int argc, const char** argv)
{
  ...
  using gemm_t           = pea::GemmOp<0, 0, false, true, kInt8, kInt4, kFloat32, kFloat32, true>;
  ...
  using gemm_sim_t               = compute_model::gemm::GemmSim<0, 0, false, true, int8_t, int4_t, float, float, true>;
