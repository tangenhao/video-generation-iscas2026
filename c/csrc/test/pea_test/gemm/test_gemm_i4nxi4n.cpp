...
int main(int argc, const char** argv)
{
  ...
  using gemm_t           = pea::GemmOp<0, true, true, 0, kInt4, kInt4, kFloat32, kFloat32, true>;
  ...
  using gemm_sim_t = compute_model::gemm::GemmSim<0, true, true, false, int4_t, int4_t, float, float, true>;
