...
int main(int argc, const char** argv)
{
  ...
  using gemm_t           = pea::GemmOp<0, 0, 0, 0, kInt8, kInt8, kFloat32, kFloat32, true>;
  ...
  using gemm_sim_t = compute_model::gemm::GemmSim<0, 0, false, false, int8_t, int8_t, float, float, true>;
  ...
  gemm_sim_t::Arguments args_sim = {
    ofmap, ifmap, weight, tile_m, block_n_group, block_k_group, Tensor<int8_t>(), ifmap_scale, weight_scale, Tensor<int8_t>()};
