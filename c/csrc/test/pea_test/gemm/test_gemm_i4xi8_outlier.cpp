...
int main(int argc, const char** argv)
{
  ...
  using gemm_t           = pea::GemmOp<0, 0, 0, true, kInt4, kInt8, kFloat32, kFloat32, true>;
  ...
  using gemm_sim_t               = compute_model::gemm::GemmSim<0, 0, false, true, int4_t, int8_t, float, float, true>;
