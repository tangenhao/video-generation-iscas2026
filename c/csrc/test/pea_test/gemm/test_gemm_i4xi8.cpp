...
int main(int argc, const char** argv)
{
  ...
  using gemm_t           = pea::GemmOp<0, 0, 0, 0, kInt4, kInt8, kInt32, kInt32, true>;
  ...
  using gemm_sim_t = compute_model::gemm::GemmSim<0, 0, false, false, int4_t, int8_t, int32_t, int32_t, true>;
  ...
  auto ofmap  = zeros<int32_t>({n_group, m, n_group_size}, kInt32);
