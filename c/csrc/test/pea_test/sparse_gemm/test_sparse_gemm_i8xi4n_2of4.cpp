...
int main(int argc, const char** argv)
{
  ...
  using gemm_t           = pea::GemmOp<SPARSE_ENABLE, 0, true, false, kInt8, kInt4, kFloat32, kFloat32, false>;
  ...
  using gemm_sim_t               = compute_model::gemm::GemmSim<SPARSE_ENABLE, false, true, false, int8_t, int4_t, float, float, true>;
  gemm_sim_t::Arguments args_sim = {
    ofmap, ifmap_transform, weight_sparse_compress, tile_m, block_n_group, block_k_group, ifmap_mask_transform, ifmap_scale, weight_scale};
