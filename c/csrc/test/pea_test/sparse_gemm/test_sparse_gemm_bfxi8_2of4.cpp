...
int main(int argc, const char** argv)
{
  ...
  using gemm_t           = pea::GemmOp<SPARSE_ENABLE, 0, 0, 0, kBfloat16, kInt8, kFloat32, kFloat32, false>;
  ...
  auto weight_dense = randn<int8_t>({n_group, k_group / 2, n_group_size, k_group_size * 2}, kHalf, -128.0f, 127.0f, 100);
  ...
  using gemm_sim_t               = compute_model::gemm::GemmSim<SPARSE_ENABLE, false, false, false, bfloat16, int8_t, float, float, true>;
