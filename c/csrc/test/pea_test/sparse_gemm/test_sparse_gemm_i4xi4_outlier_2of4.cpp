...
int main(int argc, const char** argv)
{
  ...
  using gemm_t           = pea::GemmOp<SPARSE_ENABLE, 0, false, true, kInt4, kInt4, kFloat32, kFloat32, false>;
  ...
  auto weight_dense  = randn<int4_t>({n_group, k_group, n_group_size, k_group_size}, kHalf, -8.0f, 7.0f, 100);
  ...
  using gemm_sim_t               = compute_model::gemm::GemmSim<SPARSE_ENABLE, false, false, true, int4_t, int4_t, float, float, true>;
