...
int main(int argc, const char** argv)
{
  ...
  using gemm_t           = pea::GemmOp<SPARSE_ENABLE, 0, false, true, kInt8, kInt8, kFloat32, kFloat32, false>;
  ...
  using gemm_sim_t               = compute_model::gemm::GemmSim<SPARSE_ENABLE, false, false, true, int8_t, int8_t, float, float, true>;
