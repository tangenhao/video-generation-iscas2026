...
int main(int argc, const char** argv)
{
  ...
  using gemm_t           = pea::GemmOp<SPARSE_ENABLE, 0, 0, 0, kBfloat16, kInt4, kFloat32, kFloat32, false>;
  ...
  auto weight_dense = randn<int4_t>({n_group, k_group / 4, n_group_size, k_group_size * 4}, kHalf, -8.0f, 7.0f, 100);
  ...
  using gemm_sim_t               = compute_model::gemm::GemmSim<SPARSE_ENABLE, false, false, false, bfloat16, int4_t, float, float, true>;
