...
int main(int argc, const char** argv)
{
  ...
  using gemm_t           = pea::GemmOp<SPARSE_ENABLE, 0, false, false, kInt8, kInt4, kFloat32, kFloat32, false>;
  ...
  using gemm_sim_t               = compute_model::gemm::GemmSim<SPARSE_ENABLE, false, false, false, int8_t, int4_t, float, float, true>;
