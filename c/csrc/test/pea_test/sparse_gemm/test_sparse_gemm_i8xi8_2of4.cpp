...
int main(int argc, const char** argv)
{
  ...
  using gemm_t           = pea::GemmOp<SPARSE_ENABLE, 0, 0, 0, kInt8, kInt8, kInt32, kInt32, false>;
  ...
  using gemm_sim_t               = compute_model::gemm::GemmSim<SPARSE_ENABLE, false, false, false, int8_t, int8_t, int32_t, int32_t, true>;
