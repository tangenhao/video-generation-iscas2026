...
int main(int argc, const char** argv)
{
  ...
  using conv2d_t           = pea::Conv2dOp<SPARSE_ENABLE, 0, 0, 0, kInt8, kBfloat16, kFloat32, kFloat32, true>;
  ...
  auto ifmap        = randn<int8_t>({ic_group / 2, h, w, ic_group_size * 2}, kHalf, -128.0f, 127.0f, 0);
  auto weight_dense = randn<bfloat16>({oc_group, ic_group, kh, kw, oc_group_size, ic_group_size}, kBfloat16, -8.0f, 7.0f, 100);
  ...
  using conv2d_sim_t = compute_model::conv2d::Conv2dSim<SPARSE_ENABLE, 0, false, false, int8_t, bfloat16, float, float, true>;
