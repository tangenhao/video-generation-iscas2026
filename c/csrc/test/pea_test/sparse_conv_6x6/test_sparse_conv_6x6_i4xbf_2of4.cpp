...
int main(int argc, const char** argv)
{
  ...
  using conv2d_t           = pea::Conv2dOp<SPARSE_ENABLE, 0, 0, 0, kInt4, kBfloat16, kFloat32, kFloat32, true>;
  ...
  auto ifmap        = randn<int4_t>({ic_group / 4, h, w, ic_group_size * 4}, kHalf, -8.0f, 7.0f, 0);
  ...
  using conv2d_sim_t = compute_model::conv2d::Conv2dSim<SPARSE_ENABLE, 0, false, false, int4_t, bfloat16, float, float, true>;
