...
int main(int argc, const char** argv)
{
  ...
  using conv2d_t           = pea::Conv2dOp<0, 0, 0, true, kInt8, kInt8, kFloat32, kFloat32, true>;
  ...
  auto outlier_scale                  = randn<half>({h, w}, kHalf, -1.0f, 1.0f, 156);
  using conv2d_sim_t                  = compute_model::conv2d::Conv2dSim<0, false, false, true, int8_t, int8_t, float, float, true>;
