...
int main(int argc, const char** argv)
{
  ...
  using conv2d_t           = pea::Conv2dOp<0, true, false, true, kInt4, kInt8, kFloat32, kFloat32, true>;
  ...
  auto weight        = randn<int8_t>({oc_group, ic_group, kh, kw, oc_group_size, ic_group_size}, kHalf, -128.0f, 127.0f, 100);
  ...
  using conv2d_sim_t                  = compute_model::conv2d::Conv2dSim<0, true, false, true, int4_t, int8_t, float, float, true>;
  ...
  auto outlier_index_pad = zeros<int8_t>({ic_group / 2, h, w, ic_group_size}, kInt8);
