...
int main(int argc, const char** argv)
{
  ...
  using conv2d_t           = pea::Conv2dOp<0, 0, 0, 0, kInt4, kHalf, kFloat32, kFloat32, true>;
  ...
  using conv2d_sim_t                  = compute_model::conv2d::Conv2dSim<0, false, false, false, int4_t, half, float, float, true>;
