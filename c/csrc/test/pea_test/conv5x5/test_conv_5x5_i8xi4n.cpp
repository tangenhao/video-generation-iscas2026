...
int main(int argc, const char** argv)
{
  ...
  using conv2d_t           = pea::Conv2dOp<0, 0, true, 0, kInt8, kInt4, kFloat32, kFloat32, true>;
  ...
  using conv2d_sim_t                  = compute_model::conv2d::Conv2dSim<0, false, true, false, int8_t, int4_t, float, float, true>;
