...
int main(int argc, const char** argv)
{
  ...
  using conv2d_t           = pea::Conv2dOp<0, true, false, false, kInt4, kInt4, kFloat32, kFloat32, true>;
  ...
  auto weight       = randn<int4_t>({oc_group, ic_group, kh, kw, oc_group_size, ic_group_size}, kHalf, -8.0f, 7.0f, 100);
  ...
  using conv2d_sim_t                  = compute_model::conv2d::Conv2dSim<0, true, false, false, int4_t, int4_t, float, float, true>;
