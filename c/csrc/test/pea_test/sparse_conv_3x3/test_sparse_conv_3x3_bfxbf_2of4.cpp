...
int main(int argc, const char** argv)
{
  ...
  using conv2d_t           = pea::Conv2dOp<SPARSE_ENABLE, 0, 0, 0, kBfloat16, kBfloat16, kFloat32, kFloat32, true>;
  ...
  auto weight_dense = randn<bfloat16>({oc_group, ic_group, kh, kw, oc_group_size, ic_group_size}, kBfloat16, -1.0f, 1.0f, 100);
  ...
  using conv2d_sim_t = compute_model::conv2d::Conv2dSim<SPARSE_ENABLE, 0, false, false, bfloat16, bfloat16, float, float, true>;
