...
int main(int argc, const char** argv)
{
  ...
  using conv2d_t           = pea::Conv2dOp<SPARSE_ENABLE, true, 0, 0, kInt4, kInt8, kInt32, kInt32, true>;
  ...
  auto ofmap        = zeros<int32_t>({oc_group, ofmap_h, ofmap_w, oc_group_size}, kInt32);
  ...
  using conv2d_sim_t = compute_model::conv2d::Conv2dSim<SPARSE_ENABLE, true, false, false, int4_t, int8_t, int32_t, int32_t, true>;
