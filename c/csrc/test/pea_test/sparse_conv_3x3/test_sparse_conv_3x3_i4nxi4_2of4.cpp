...
int main(int argc, const char** argv)
{
  ...
  using conv2d_t           = pea::Conv2dOp<SPARSE_ENABLE, true, false, 0, kInt4, kInt4, kInt32, kInt32, true>;
  ...
  using conv2d_sim_t = compute_model::conv2d::Conv2dSim<SPARSE_ENABLE, true, false, false, int4_t, int4_t, int32_t, int32_t, false>;
