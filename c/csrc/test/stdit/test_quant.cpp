...
int main(int argc, const char** argv)
{
  ...
  //2: ascale(reg0)=max/127, recip(ascale, reg2)
  ...
  //3: ascale*wscale(reg1), store to scale.
  ...
  //4: x_in*inv_scale, store to qact.
  ...
  insn_series.insert(insn_series.end(), step_4_config_insns.begin(), step_4_config_insns.end());
